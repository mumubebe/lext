...
About
```console
usage: __main__.py [-h] [-m {sha1,sha256}] -d DATA -i INJECT -s SIGNATURE -l SECRET_LENGTH [--ignore_signature IGNORE_SIGNATURE]
                   [--ignore_outputdata IGNORE_OUTPUTDATA]
...
optional arguments:
  ...
  --ignore_signature IGNORE_SIGNATURE
                        Ignore output return of signature
  --ignore_outputdata IGNORE_OUTPUTDATA
                        Ignore output return of new data message
```
